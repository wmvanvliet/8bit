...
UCODE_TEMPLATE = [
    ...
    [MI|CO,  RO|II|CE,  IO|MI,     SS|RO|BI,       MI|CO,          MI|RO|CE,     BO|SS|RI,  SR,  ],  # 00011001 -      _B
    [MI|CO,  RO|II|CE,  IO|MI,     SS|RO|BI,       MI|CO,          MI|RO|CE,     BO|SS|RI,  SR,  ],  # 00011010 -      _C
    [MI|CO,  RO|II|CE,  IO|MI,     SS|RO|BI,       MI|CO,          MI|RO|CE,     BO|SS|RI,  SR,  ],  # 00011011 -      _D
    [MI|CO,  RO|II|CE,  IO|MI,     SS|RO|BI,       MI|CO,          MI|RO|CE,     BO|SS|RI,  SR,  ],  # 00011100 -      _E
    [MI|CO,  RO|II|CE,  IO|MI,     SS|RO|BI,       MI|CO,          MI|RO|CE,     BO|SS|RI,  SR,  ],  # 00011101 -      _F
    [MI|CO,  RO|II|CE,  IO|MI,     SS|RO|BI,       MI|CO,          MI|RO|CE,     BO|SS|RI,  SR,  ],  # 00011110 -      _G
    [MI|CO,  RO|II|CE,  IO|MI,     SS|RO|BI,       MI|CO,          MI|RO|CE,     BO|SS|RI,  SR,  ],  # 00011111 -      _H
